...
def get_search_index(file_name="Case Manager User Manual V4.1.0 (1).pdf", index_folder="index"):
    # load embeddings
...
_rag_template = """Answer the question in detail based only on the following context,
{context}
...
def get_rag_chain(file_name="Case Manager User Manual V4.1.0 (1).pdf", index_folder="index", retrieval_cb=None):
...
def get_rag_fusion_chain(file_name="Case Manager User Manual V4.1.0 (1).pdf", index_folder="index", retrieval_cb=None):
    vectorstore = get_search_index(file_name, index_folder)
    retriever = vectorstore.as_retriever()
...
def get_lc_oai_tools(file_name="Case Manager User Manual V4.1.0 (1).pdf", index_folder="index"):
...
def get_agent_chain(file_name="Case Manager User Manual V4.1.0 (1).pdf", index_folder="index", callbacks=None):
